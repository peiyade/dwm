...
static const char *const autostart[] = {
	"fcitx5", NULL,
	"redshift", "-l", "23:133", NULL,
	"sh", "-c", "cd /home/py06/newtab/; hugo server -p 5000", NULL,
	/* "sh", "-c", "emacs --daemon", NULL, */
	/* "sudo", "sh", "-c", "sudo v2raya", NULL, */
	NULL
};
...
static const char *altbrowsercmd[]  = { "opera", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,    XK_s,                    spawn,          {.v = appfindercmd } },
	{ MODKEY,              XK_Return,               spawn,          {.v = termcmd } },
	{ MODKEY,              XK_z,                    spawn,          {.v = editorcmd } },
